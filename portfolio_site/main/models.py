...
class projectModel(models.Model):
    project_title = models.CharField(null=True, blank=True, max_length=200)
    ...
    project_topic_two_title = models.CharField(null=True, blank=True, max_length=100)
    ...
    project_topic_three_title = models.CharField(null=True, blank=True, max_length=100)
...
class blogPosts(models.Model):
    ...
    blog_topic_one_title = models.CharField(null=True, blank=True, max_length=200)
    ...
    blog_topic_two_title = models.CharField(max_length=200, null=True, blank=True)
